 ...
 * @author Erwin
 */
public class EjecutarModificacion extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String[] atributos = consulta.atributos;
        HashMap<String, String> mapa = new HashMap<>();
        for(String atributo : atributos)
        {
            if(atributo.equals(consulta.atributos[0]))
                    continue;
            mapa.put(atributo, request.getParameter(atributo));
        }
        consulta.update(identificador, mapa);
